    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-border-subtle bg-bg-secondary/60 backdrop-blur-sm mb-8 animate-fade-in">
                ...
                {/* Headline */}
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-hero text-text-primary font-satoshi mb-6 animate-slide-up">
                    Build Systems.{' '}
                ...
                {/* Subtext */}
                <p className="text-lg sm:text-xl text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up animation-delay-100">
                ...
                {/* Social proof mini */}
                <p className="mt-12 text-text-muted text-sm animate-fade-in animation-delay-300">
