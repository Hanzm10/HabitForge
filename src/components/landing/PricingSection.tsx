        ...
        <section className="py-24 px-6 bg-bg-secondary/30">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
                    {/* Free Tier */}
                    <div className="relative p-8 rounded-2xl border-2 border-accent-primary bg-bg-card">
                    ...
                    {/* Pro Tier */}
                    <div className="relative p-8 rounded-2xl border border-border-subtle bg-bg-card opacity-80">
                        <div className="absolute -top-3 left-8">
